/**
 * @file noise.js
 * @description 3D Noise generation (Simplex/Perlin approximation) for procedural textures.
 */
...
if (typeof self !== 'undefined') self.Noise = Noise;
